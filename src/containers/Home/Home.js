...
class Home extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.info.info[17].value === "no" && this.props.info.info[17].value === "no") {
                    ...
                    : (
                        <Segment placeholder raised>
                            <Modal
                                ...
                                <Modal.Content>
                                    <b>Launching of akibtanjim.com by someone special and close to my heart</b>
                                    <div
                                        class="pyro"
                                        style={{
                                        background: "#000",
                                        display: this.state.showFireWorks
                                            ? ""
                                            : "none"
                                    }}>
                            ...
                            <Grid columns={2} stackable textAlign="left">
                                <Grid.Row verticalAlign="middle">
                                    ...
                                    <Grid.Column width={6}>
                                        <Image src={imageUrl + "/others/" + this.props.info.info[16].value} size="big"/>
                                    </Grid.Column>
                                </Grid.Row>
                            </Grid>
                        </Segment>
